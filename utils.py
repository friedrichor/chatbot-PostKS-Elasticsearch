...
def pickle_glove_vectors():
    ...
    with open("word2vec/sgns_wiki_bigram-char.txt", "r", encoding='utf-8') as f:
        next(f)
        for line in f:
            ...
            try:
                ...
                pass
    print("Start to pickle word2vec vectors...")
    with gzip.open("word2vec/word2vec_vectors.pkl", "w") as f:
        pickle.dump(glove_vectors, f)
    print("Tensors are saved to word2vec/word2vec_vectors.pkl")


def load_glove_vectors():
    print("Loading word2vec vectors")
    if os.path.exists("word2vec/word2vec_vectors.pkl"):
        with gzip.open("word2vec/word2vec_vectors.pkl", "rb") as f:
